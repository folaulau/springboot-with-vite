...
public class SpringbootWithViteApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootWithViteApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				System.out.println("************************ Springboot with Vite ***********************************");
				...
				System.out
						.println("** External Url: http://localhost:" + env.getProperty("server.port"));
